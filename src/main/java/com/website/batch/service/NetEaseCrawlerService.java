...
import com.website.batch.dto.WyyContent;
import com.website.batch.dto.WyyUserContent;
import com.website.batch.util.EncryptUtils;
...
public class NetEaseCrawlerService {
    ...
    public List<Map<String, Object>> getNetEaseSongListInfo(String playListId) {
        try {
